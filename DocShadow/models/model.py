...
from .backbone import DFE
from .blocks import SPP, Aggreation, ConvLayer
...
class Backbone(nn.Module):
    ...
    def forward(self, inp):
        ...
        out = (
            ...
            + self.coefficient_1_0[1, :][None, :, None, None] * out_enc
        )
